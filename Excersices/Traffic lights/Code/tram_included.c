...
#define TRAM_INTERVAL 500  // T1

volatile int Button_pezou  = 0;
volatile int Cooldown = 0;
volatile int Tram_energo = 0;
...
ISR(TCA0_HCMP0_vect){
	TCA0.SPLIT.INTFLAGS = TCA_SPLIT_HCMP0EN_bm; // Clear 
	Tram_energo = 1; // Set to tram se energo  
}